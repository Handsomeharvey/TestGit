...
/**
 * 状态栏透明 Created by SCWANG on 2016/10/26.
 */
...
public class StatusBarUtil {
	...
	public static float DEFAULT_ALPHA = 0;// Build.VERSION.SDK_INT >=
	...
	public static int getStatusBarHeight(Context context) {
		...
		if (resId > 0) {
			...
			result = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, result,
